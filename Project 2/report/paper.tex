...
\subfigure[NN with various dropouts]{\label{fig:histC}\includegraphics[width=0.49\textwidth]{images/NNKCVplotdropout.png}}
\subfigure[NN with various L2 weight penalties]{\label{fig:loghist}\includegraphics[width=0.49\textwidth]{images/NNKCVplotL2weight.png}}
\caption{Test errors}
\end{figure}
