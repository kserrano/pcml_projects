...
\begin{figure}
\centering
\subfigure[0-1 loss]{\includegraphics[width=0.5\textwidth]{images/penLogRegCrossVall01Loss.eps}}
\subfigure[rmse]{\includegraphics[width=0.5\textwidth]{images/penLogRegrmse.eps}}
\subfigure[log loss]{\includegraphics[width=0.5\textwidth]{images/penLogRegLogloss.eps}}
